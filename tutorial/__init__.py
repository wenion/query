...
def task_classification(request):
    ...
    if max(prob) <= prob_task[pred]:
        return invalid_result
    expert_trace_dict = {
        "Updating Moodle Information": "<ol><li>Click on the button 'Turn editing on'<img src='https://drive.google.com/file/d/1jPQCnRKBTQw48Ng_IB-y8eVo25n0exb9/preview' style='width=80%'></li><li>Go to the moodle section, click 'Edit settings'<img src='https://drive.google.com/file/d/1IbLHvWs2YNQqvNs0dkY61kz5Ehmcr9Zq/preview' style='width=80%'></li><li>Make changes, save the changes and 'Turn edit off'</li></ol>",
        "Embedding Moodle Media Resource": "<ol><li>Go to the moodle section, click 'Edit settings'<img src='https://drive.google.com/file/d/1fkJtbAboUa1hv52doLmtC84Fg9dgesC7/preview' style='width=80%'></li><li>In the text edit panel, click 'Insert moodle media'<img src='https://drive.google.com/file/d/11XamKYjJNGqaIr13fA8ZITCBgAjxf_bO/preview' style='width=80%'></li><li>Insert video link</li><li>Save resources and 'Turn edit off'</li></ol>",
        "Adding Moodle Forum": "<ol><li>Click on the button 'Add an activity or resource'<iframe src='https://drive.google.com/file/d/1223SAXzASkzZgOGhlZFTPctXr9wwahLs/preview' width='80%' height='auto' allow='autoplay'></iframe></li><li>Select 'Forum'<img src='https://drive.google.com/file/d/1E5BDdXABaUQ-FKABpRowPcm1vsNvQ7YW/preview' style='width=80%'></li><li>Select 'Forum type'<img src='https://drive.google.com/file/d/14zkoM6INqHhGkWAr3IxunbkJ3rRs7RIU/preview' style='width=80%'></li><li>Save the forum and 'Turn edit off'</li></ol>"
    }
    # expert_trace_dict = {
