...
def task_classification(request):
    ...
    expert_trace_dict = {
        ...
        "Adding Moodle Forum": "<ol><li>Click on the button 'Add an activity or resource'<img src='/usr/share/nginx/html/Steve_Li/add moodle forum step 1.png' width='80%' height='auto'></li><li>Select 'Forum'<img src='https://lh3.googleusercontent.com/drive-viewer/AEYmBYRTtHnhzNWGf02SdqgZUcbryNMX_Pfi2RvsmawpZGBXBVgMMq3OKsEVmvxd1vsdphZOL6Z78Uo6ReQzEpTAxvRO4AOAUg=s2560' style='width=80%'></li><li>Select 'Forum type'<img src='https://lh3.googleusercontent.com/drive-viewer/AEYmBYQlWLcEv1GQG4TKlFcrrE6mquBuXXlq4srdcU3_3dfyVp_VuUaWVkUawxoybutOju86dHo-1fWTOnk-HFehkgKBe85jaw=s1600' style='width=80%'></li><li>Save the forum and 'Turn edit off'</li></ol>"
    }
    # expert_trace_dict = {
